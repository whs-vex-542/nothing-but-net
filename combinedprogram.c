...
#pragma config(Motor,  port6,           FW1,           tmotorVex393, openLoop, reversed)
#pragma config(Motor,  port7,           FW2,           tmotorVex393, openLoop)
#pragma config(Motor,  port8,           FW3,           tmotorVex393, openLoop, reversed)
#pragma config(Motor,  port9,           FW4,           tmotorVex393, openLoop)
...
FW1 and FW3 are reversed so flywheel can shoot.
