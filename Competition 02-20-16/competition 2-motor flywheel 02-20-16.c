...
task autonomous()
{
	...
	// Correct the direction of drivetrain by rotating left slightly //
	RotateLeft(50);
	wait1Msec(125);

	// Position the drivetrain right in front of the goal, power up flywheel //
	RotateLeft(0);
	Flywheel(50);
	driveStraight(127);
	wait1Msec(3250);
